...
class InstagramBot:
	def __init__(self, username, password):
		...
		self.username_influencer = 'achadosveganos' #quem sera o primeiro insta a ser aberto
		#https://github.com/mozilla/geckodriver/releases
		self.bot = webdriver.Firefox(executable_path = '/Applications/geckodriver')
...
insta = InstagramBot('vegaboxbox', '2541cbaa')
time.sleep(3)
